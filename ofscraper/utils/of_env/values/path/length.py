...
def load_max_lengths_config():
    ...
    # Default: 530
    config['WINDOWS_MAX_PATH_BYTES'] = int(os.getenv('OFSC_WINDOWS_MAX_PATH_BYTES', '530'))
    ...
    # Default: 254
    config['LINUX_MAX_FILE_NAME_BYTES'] = int(os.getenv('OFSC_LINUX_MAX_FILE_NAME_BYTES', '254'))
