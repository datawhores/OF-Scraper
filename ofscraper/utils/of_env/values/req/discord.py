...
def load_discord_config():
    ...
    if discord_total_timeout_env is not None:
        try:
            ...
            print(f"Warning: OFSC_DISCORD_TOTAL_TIMEOUT environment variable '{discord_total_timeout_env}' is not a valid integer. Using default None.")
            config['DISCORD_TOTAL_TIMEOUT'] = None
    else:
        config['DISCORD_TOTAL_TIMEOUT'] = None # Explicitly set to None if not in env or invalid
