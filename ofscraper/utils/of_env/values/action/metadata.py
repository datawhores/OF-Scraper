...
def load_metadata_config():
    ...
    config['REMOVE_UNVIEWABLE_METADATA'] = remove_unviewable_metadata_env.lower() in ('true', '1')
    ...
    config['ALT_FORCE_KEY'] = os.getenv('OFSC_ALT_FORCE_KEY', 'True').lower() in ('true', '1')
