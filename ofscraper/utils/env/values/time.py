...
def load_expiry_config():
    ...
    if key_expiry_env is not None:
        try:
            ...
            print(f"Warning: OFSC_KEY_EXPIRY environment variable '{key_expiry_env}' is not a valid integer. Using default None.")
    ...
    config['THREE_DAY_SECONDS'] = int(os.getenv('OFSC_THREE_DAY_SECONDS', str(86400 * 3)))
    ...
    # Default: 86400 (1 day)
    config['PROFILE_DATA_EXPIRY_ASYNC'] = int(os.getenv('OFSC_PROFILE_DATA_EXPIRY_ASYNC', '86400'))
