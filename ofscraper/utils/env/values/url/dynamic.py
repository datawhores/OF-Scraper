...
def load_dynamic_url_config():
    ...
    config["XAGLER_URL"] = os.getenv("OF_XAGLER_URL", "https://raw.githubusercontent.com/xagler/dynamic-rules/main/onlyfans.json")

    # RAFA_URL: "https://raw.githubusercontent.com/rafa-9/dynamic-rules/main/rules.json"
    # Environment variable: OF_RAFA_URL
    config["RAFA_URL"] = os.getenv("OF_RAFA_URL", "https://raw.githubusercontent.com/rafa-9/dynamic-rules/main/rules.json")
    ...
    config["DIGITALCRIMINALS"] = os.getenv("OF_DIGITALCRIMINALS_URL", "https://raw.githubusercontent.com/DATAHOARDERS/dynamic-rules/main/onlyfans.json")
    ...
    config["DATAWHORES_URL"] = os.getenv("OF_DATAWHORES_URL", "https://raw.githubusercontent.com/datawhores/onlyfans-dynamic-rules/main/dynamicRules.json")
    ...
    config["DEVIINT_URL"] = os.getenv("OF_DEVIINT_URL", "https://raw.githubusercontent.com/deviint/onlyfans-dynamic-rules/main/dynamicRules.json") 
    ...
    config["RILEY_URL"] = os.getenv("OF_RILEY_URL", "https://raw.githubusercontent.com/riley-access-labs/onlyfans-dynamic-rules-1/refs/heads/main/dynamicRules.json")
