    ...
    try:
      ...
      for pid in self._pids:
            try:
                ...
                if not self.previous_time.get(pid) or not self.previous_stats.get(pid):
                ...
                if curr_time-previous_time<1.5:
                  ...
                  new_speed=(curr_stats.write_bytes - previous_stats.write_bytes)/(curr_time-previous_time) or previous_speed
