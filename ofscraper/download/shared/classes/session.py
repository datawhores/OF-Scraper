...
class download_session(sessionManager.sessionManager):
      def __init__(self,sem=None,retries=None,wait_min=None,wait_max=None,new_request_auth=None) -> None:
        ...
        super().__init__(sem=sem,retries=retries,wait_min=wait_min,wait_max=wait_max,new_request_auth=new_request_auth)
