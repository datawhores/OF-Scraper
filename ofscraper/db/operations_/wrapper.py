...
def operation_wrapper_async(func: abc.Callable):
    async def inner(*args, **kwargs):
        ...
        try:
            ...
            conn = sqlite3.connect(database_path, check_same_thread=False, timeout=db_timeout)
...
def operation_wrapper(func: abc.Callable):
    def inner(*args, **kwargs):
        ...
        try:
            ...
            conn = sqlite3.connect(database_path, check_same_thread=True, timeout=db_timeout)
            conn.row_factory = sqlite3.Row
