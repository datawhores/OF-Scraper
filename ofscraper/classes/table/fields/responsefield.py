...
"""
    def __init__(self, name: str) -> None:
        ...
        self._pinned=Selection("Pinned",value="pinned",disabled=False,id=f"{self.filter_name}_pinned",initial_state=True)
        self._archived=Selection("Archived",value="archived",disabled=False,id=f"{self.filter_name}_archived",initial_state=True)
